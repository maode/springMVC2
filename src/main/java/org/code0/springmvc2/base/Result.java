...
public final class Result {
    ...
    public static  Result ok(String message, Object data, Integer code) {
    ...
    public static  Result fail(String message, Object data, Integer code) {
...
//        System.out.println(r3.getData());
       ...
       // System.out.println(Result.jsonp("callback", Result.ok("Hello")));
    	System.out.println(JSON.toJSONString(Result.ok()));
