...
<head>
	...
	<title><spring:message code="msg.stuInfo"/></title>
...
<body>
 	...
 	<h1><spring:message code="msg.stuInfo" /></h1>
	<form:form modelAttribute="student" class="form-horizontal">
		...
		<div class="row">
			...
			<div class="form-actions floatRight">
				<input id="bakBtn" type="button" value='<spring:message code="msg.bak"/>' class="btn btn-primary btn-sm">
			</div>
		</div>
	</div>
